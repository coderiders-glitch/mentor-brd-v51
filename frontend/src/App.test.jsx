...
import { render, screen, fireEvent, waitFor } from '@testing-library/react';import App from './App';
...
describe('App', () => {
  ...
  it('displays search results after successful search', async () => {
    const mockResults = [
      { name: 'Aman Sharma', title: 'Software Engineer', url: 'https://linkedin.com/in/amansharma' },
      { name: 'Aman Sharma', title: 'Product Manager', url: 'https://linkedin.com/in/amansharma2' }
    ];
    api.searchAlumni.mockResolvedValue({ results: mockResults });
  ...
  it('shows empty state when no results found', async () => {
    api.searchAlumni.mockResolvedValue({ results: [] });
